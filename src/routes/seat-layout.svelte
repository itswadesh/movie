...
<div class="theatre">
	...
	<div class="arrangement">
		{#each layout as l}
			<p>
				{l.catagory} :- ₹{l.cp}____________________________________________________________________________________________________________________________________________________
			</p>
			<p>
